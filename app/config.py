...
class Settings:
    ...
    telebirr_number: str = os.getenv("TELEBIRR_NUMBER", "")
    telebirr_name: str = os.getenv("TELEBIRR_NAME", "")
    cbe_account_number: str = os.getenv("CBE_ACCOUNT_NUMBER", "")
    cbe_account_name: str = os.getenv("CBE_ACCOUNT_NAME", "")
