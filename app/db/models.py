...
class Transaction(Base):
    ...
    # Manual transfer proof (Telebirr / CBE). Only one of these is usually set.
    proof_photo_file_id: Mapped[str | None] = mapped_column(String(256), nullable=True)
    proof_note: Mapped[str | None] = mapped_column(String(256), nullable=True)
